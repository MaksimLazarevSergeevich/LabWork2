...
<pre> ```text /LabWork2 ├── /include │ ├── archer.h │ ├── berserk.h │ ├── bot.h │ ├── bow.h │ ├── crimson_grail.h │ ├── cudgel.h │ ├── debuff_bomb.h │ ├── energy_potion.h │ ├── game_controller.h │ ├── game_fighter.h │ ├── game_menu.h │ ├── goblin.h │ ├── health_potion.h │ ├── hero.h │ ├── item.h │ ├── mage.h │ ├── magic_staff.h │ ├── sword.h │ ├── vampire.h │ └── weapon.h ├── /src │ ├── archer.cpp │ ├── berserk.cpp │ ├── bot.cpp │ ├── bow.cpp │ ├── crimson_grail.cpp │ ├── cudgel.cpp │ ├── debuff_bomb.cpp │ ├── energy_potion.cpp │ ├── game_controller.cpp │ ├── game_fighter.cpp │ ├── game_menu.cpp │ ├── goblin.cpp │ ├── health_potion.cpp │ ├── hero.cpp │ ├── item.cpp │ ├── mage.cpp │ ├── magic_staff.cpp │ ├── sword.cpp │ ├── vampire.cpp │ └── weapon.cpp ├── /tests │ └── ... ├── main.cpp ├── Makefile └── README.md ``` </pre>