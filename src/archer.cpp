...
/**
 * @brief Archer class constructor, initializing the hero with predefined attributes.
 * 
 * Initializes:
 * - Name: "Archer"
 * - Max Health: 80
...
/**
 * @brief Special ability for the Archer hero.
 * 
 * If the Archer has at least 10 energy, this ability:
 * - Spends 10 energy
 * - Deals damage equal to one-third of the enemy's current health
